...
public class Parser {
    ...
    /**
     * multiple choice single response {Comment �a va? |type="()"} + The correct
     * answer. - Distractor. - Distractor. - Distractor {Question |type="[]"} +
     ...
     */
    public final Question parserFonction(final String question) {
        ...
        if (tokens[1].equals("()")) {
            ...
            q = new Question(Type.MULTIPLE, reponse, nbbonnereponse++,
                    texteQuestion);
